...
var studentsnames = [ 'Micheal', 'Peter', 'Phil', 'Jordan', 'Levis', 'Rhoda'];
var firstname = studentsnames[0]
var lastname = studentsnames[5]
var totalStudents = [studentsnames.length];
console.log(`This class has ` + totalStudents + ` Students`);

for (i=0; i < totalStudents; i++) {
    console.log(`Welcome to the class ` + studentsnames[i]);
}
...
// var studentss = ['Gracie', 'Alicia', 'Cryon', 'Beaula']
